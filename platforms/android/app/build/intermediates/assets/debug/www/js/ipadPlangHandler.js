...
function ModeSelector(ev)
{
	...
	*/
	...
	$('<div/>',{class:"phmodal-container"}).appendTo('#phmodalModeSel');
	$(".phmodal-container").html("<i id='setpl' class='setpl iconselector far fa-address-book'></i><i id='setyt' class='setyt iconselector fab fa-youtube'></i>");
...
function PhotoWidget()
{
	...
	$('<div/>',{class:"phmodal-container"}).appendTo('#phmodalPHOTOWidget');
	$(".phmodal-container").html("<input id='inpVirnumm' name='inpVirnumm' type='text' placeholder='Virunumm'><input id='inpNumm' name='inpNumm' type='text' placeholder='Numm'><button type='button' class='searchbutton' id='btnPhoto'>Foto maachen</button><div id='thewidgetcontent' style='height:491px;overflow-y:scroll;'><img id='preview-image' src=''></img><button type='button' id='sendPhotoData'>Späicheren</button></div>");
...
function ShowService(servicename)
{
	...
	if (singleService.id < 30)
	{
		...
		for (var _i =0;_i < singleService.encadrantsMoies.length;_i++)
		{
			...
			result+="<div class='phphoto flipcard-front'><img src='img/personal/"+singleService.encadrantsMoies[_i].photo+"'></div>";
		...
		for (var _i =0;_i < singleService.usagersMoies.length;_i++)
		{
			...
			result+="<div class='phphoto flipcard-front'><img src='img/personal/"+singleService.usagersMoies[_i].photo+"'></div>";
		...
		for (var _i =0;_i < singleService.encadrantsMettes.length;_i++)
		{
			...
			result+="<div class='phphoto flipcard-front'><img src='img/personal/"+singleService.encadrantsMettes[_i].photo+"'></div>";
		...
		for (var _i =0;_i < singleService.usagersMettes.length;_i++)
		{
			...
			result+="<div class='phphoto flipcard-front'><img src='img/personal/"+singleService.usagersMettes[_i].photo+"'></div>";
	...
	else
	{
		...
		for (var _dag =0;_dag < singleService.Dag.length;_dag++)
		{
			...
			result+="<div class='phphoto flipcard-front'><img src='img/personal/"+singleService.Dag[_dag].photo+"'></div>";
		...
		for (var _moi =0;_moi < singleService.Moies.length;_moi++)
		{
			...
			result+="<div class='phphoto flipcard-front'><img src='img/personal/"+singleService.Moies[_moi].photo+"'></div>";
		...
		for (var _met =0;_met < singleService.Mettes.length;_met++)
		{
			...
			result+="<div class='phphoto flipcard-front'><img src='img/personal/"+singleService.Mettes[_met].photo+"'></div>";
