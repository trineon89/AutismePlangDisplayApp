...
function buildService(AtelierJSON) {	
	...
	switch (theAtelierjson.id)
	{
		...
		for (var _i in theAtelierjson.encadrantsMoies)
		{
			...
			// SHTML+='<div class="photo" id="'+theAtelierjson.encadrantsMoies[_i].id+'-1" style="background-image:url(\'img/personal/'+theAtelierjson.encadrantsMoies[_i].id+'.jpg\')"><div class="numm">'+theAtelierjson.encadrantsMoies[_i].numm+'</div></div>';
			...
			if (theAtelierjson.encadrantsMoies[_i].photo=="placeholder.png")
			{
		...
		for (var _i in theAtelierjson.usagersMoies)
		{
			...
			if (theAtelierjson.usagersMoies[_i].photo=="placeholder.png")
			{
		...
		for (var _i in theAtelierjson.encadrantsMettes)
		{
			...
			// SHTML+='<div class="photo" id="'+theAtelierjson.encadrantsMettes[_i].id+'-1" style="background-image:url(\'img/personal/'+theAtelierjson.encadrantsMettes[_i].id+'.jpg\')"><div class="numm">'+theAtelierjson.encadrantsMettes[_i].numm+'</div></div>';
			...
			if (theAtelierjson.encadrantsMettes[_i].photo=="placeholder.png")
			{
		...
		for (var _i in theAtelierjson.usagersMettes)
		{
			...
			// SHTML+='<div class="photo" id="'+theAtelierjson.usagersMettes[_i].id+'-1" style="background-image:url(\'img/personal/'+theAtelierjson.usagersMettes[_i].id+'.jpg\')"><div class="numm">'+theAtelierjson.usagersMettes[_i].numm+'</div></div>';
			...
			if (theAtelierjson.usagersMettes[_i].photo=="placeholder.png")
			{
...
function showDoku(theAtelierjson)
{
	...
	for (var _i in theAtelierjson.Dag)
	{
		...
		if (theAtelierjson.Dag[_i].photo=="placeholder.png")
		{
	...
	for (var _i in theAtelierjson.Moies)
	{
		...
		if (theAtelierjson.Moies[_i].photo=="placeholder.png")
		{
	...
	for (var _i in theAtelierjson.Mettes)
	{
		...
		if (theAtelierjson.Mettes[_i].photo=="placeholder.png")
		{
